...
def upgrade():
    op.add_column(
        "datasources", sa.Column("schema_perm", sa.String(length=1000), nullable=True)
    )
    op.add_column(
        "slices", sa.Column("schema_perm", sa.String(length=1000), nullable=True)
    )
    op.add_column(
        "tables", sa.Column("schema_perm", sa.String(length=1000), nullable=True)
    )
